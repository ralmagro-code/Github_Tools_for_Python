# Resolvendo Códigos em Python com o Github Copilot ou o ChatGPT 🌌
Olá!! Esse é um dos desafios da Formação em Github da Dio, minitrado pela Aline Antunes. O desafio consiste nas resoluções de códigos em python utilizando o Github Copilot ou o ChatGPT como copiloto de estudos.
Abaixo segue cada um dos códigos propostos:
